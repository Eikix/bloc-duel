...
const PlayField = forwardRef<HTMLDivElement, PlayFieldProps>(
  function PlayField({
    ...
    const cardSizeClass = immersive
      ? compact
        ? 'h-[5.35rem] w-[3.8rem] sm:h-[6.1rem] sm:w-[4.35rem] lg:h-[6.7rem] lg:w-[4.8rem] 2xl:h-[7.3rem] 2xl:w-[5.2rem]'
        : 'h-[7.8rem] w-[5.5rem]'
      : compact
        ? 'h-[6.3rem] w-[4.5rem]'
        : 'h-[7.2rem] w-[5rem]'
        ...
        <div
          ...
          className={`scrollbar-hidden relative flex items-stretch gap-3 overflow-x-auto rounded-[24px] px-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] ${
            isHighlighted
              ...
              : ''
          } ${laneClassName} ${compact ? 'min-h-[104px] py-2.5 lg:min-h-[116px] lg:py-3' : 'min-h-[132px] py-4'}`}
        >
